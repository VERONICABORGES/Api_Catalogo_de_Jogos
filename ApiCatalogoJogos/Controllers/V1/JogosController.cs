...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<JogoViewModel>>> Obter([FromQuery, Range(1, 2)] int pagina = 1, [FromQuery, Range(1, 50)] int quantidade = 10)
        {
        ...
        public async Task<ActionResult<JogoViewModel>> Obter([FromRoute] Guid idJogo)
        {
            ...
            if (jogo == null)
                return Content("Não existe jogo com este Id");
